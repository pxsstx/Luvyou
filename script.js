...
(hh = h / 2),
  (opts = {
    ...
    fireworkCircleBaseTime: 120,
    fireworkCircleAddedTime: 120,
    fireworkCircleFadeBaseTime: 20,
    fireworkCircleFadeAddedTime: 15,
    fireworkBaseShards: 0.5,
    fireworkAddedShards: 0.2,
    fireworkShardPrevPoints: 3,
    fireworkShardBaseVel: 0.2,
    fireworkShardAddedVel: 0.2,
...
// สร้าง Letter, Shard, และ Balloon Class ตามโค้ดเดิม

let animationComplete = false; // ใช้เช็คว่าแอนิเมชันเสร็จแล้วหรือยัง
